...
Karma is hosted by @IdioticAsHell and doesn't require any donations as of now but \
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1201425400 and DONATION_LINK:
            update.effective_message.reply_text(
                "You can donate him here."
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@BotOnlineDump", "I am now online!")
        except Unauthorized:
            LOGGER.warning(
